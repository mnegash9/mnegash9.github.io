                    ...
                    <div style={{ flex: 3, marginLeft: '12px', marginTop: '120px' }} className='project-images'>
                        ...
                        <section>
                            ...
                            <div style={{ display: "flex", flexDirection:"column", justifyContent: "center", textAlign: "center", alignItems: "center" }}>
                                <div style={{ backgroundColor: "#222831", height: "60px", width: "220px", cursor: "pointer" }}>
                                    <Link target="_blank" to="https://matyas.homelinuxserver.org" style={{ color: "white", fontSize: 30, margin: "20px" }}>
                                        <u>The Buzz</u>
                                    </Link>
                                </div>
